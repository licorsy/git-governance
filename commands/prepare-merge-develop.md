...
1. Confirm the current branch is a work branch (not `develop`/`hom`/`main` itself) and matches the taxonomy. If it doesn't match, report **Needs attention** and ask whether to proceed anyway or rename first.
