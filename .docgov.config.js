...
// ownership" in CLAUDE.md for the policy this file enforces mechanically.
//
...
module.exports = {
  ...
  rules: {
      ...
      entries: [
        {
          ...
          why: 'refactor/ was added to the taxonomy after feature/*->feat/* '
            + 'was renamed, and CLAUDE.md/README.md briefly still said '
            + '"feature/*" — this fact caught the same class of drift twice',
          // README.md only carries this list inside the branch-flow diagram
          // itself, which fragment_sync already pins against CLAUDE.md — no
          // separate prose restatement there to check.
          required_in: [
            { file: 'CLAUDE.md', pattern: /`feat`,\s*`fix`,\s*`refactor`,\s*`docs`,\s*`chore`,\s*`hotfix`/ },
    ...
    //   scope_dirs: ['agents', 'commands'], root_files: ['README.md', 'CLAUDE.md'],
    // },
    ...
    // "The ratchet" ----
    // The branch-flow diagram is declared once, in CLAUDE.md (see
    ...
    fragment_sync: {
      fragments: [
        { id: 'branch-flow', source: 'CLAUDE.md', destinations: ['README.md'] },
      ],
    },
  },
};
